...
impl SubtypeChecker {
  ...
  pub fn is_subtype(sub_ty: &ErlType, super_ty: &ErlType) -> bool {
    match super_ty.deref() {
      ...
      ErlType::AnyFn => matches!(
        sub_ty,
        ErlType::Fn { .. } | ErlType::FnRef { .. } | ErlType::Lambda
      ),
  ...
  fn is_subtype_of_anylist(sub_ty: &ErlType) -> bool {
    matches!(
      sub_ty,
      ErlType::List { .. } | ErlType::StronglyTypedList { .. } | ErlType::Nil
    )
  }
